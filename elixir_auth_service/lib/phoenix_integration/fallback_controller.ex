defmodule AuthService.Phoenix.FallbackController do
  @moduledoc """
  Fallback controller for Phoenix integration error handling.
  """
  ...
  def call(conn, error) do
    require Logger
    Logger.error("Unhandled error in Phoenix fallback controller: #{inspect(error)}")
